			...
			while (true) {
				...
				switch (opcion) {
					case 1:
						...
						ResponseEntity<customerDto> responseCreate = restTemplate.postForEntity(BASE_URL + "crearcliente", newCustomer, customerDto.class);
					...
					case 2:
						...
						restTemplate.delete(BASE_URL + "eliminarcliente/" + idToDelete);
					...
					case 4:
						...
						try {
							ResponseEntity<String> responseEntity = restTemplate.exchange(
									BASE_URL + "obtenerclienteporId/" + idToFetch,
									HttpMethod.GET,
					...
					case 5:
						ResponseEntity<List<customerDto>> responseBirthdateDesc = restTemplate.exchange(
								BASE_URL + "ordenadosPorFechadeNacimientoDescendente",
								HttpMethod.GET,
								null,
					...
					case 7:
						ResponseEntity<List<customerDto>> responseFirstNameAsc = restTemplate.exchange(
								BASE_URL + "OrdenadosPorNombreDeManeraAscendente",
								HttpMethod.GET,
								null,
								new ParameterizedTypeReference<List<customerDto>>() {}
						);
