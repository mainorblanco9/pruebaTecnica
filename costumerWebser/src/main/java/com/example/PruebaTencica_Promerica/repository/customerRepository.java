...
public interface customerRepository extends JpaRepository<customer, Long> {
    ...
    List<Map<String, Object>> obtenerClientesOrdenadosPorId(@Param("out_id_cedulas") String[] out_id_cedulas,
                                                            ...
                                                            @Param("out_phones") String[] out_phones,
                                                            @Param("out_birthdates") String[] out_birthdates);
    @Query(value = "CALL sp_obtener_cliente_ordenado_primernombre_asc(:out_id_cedulas, :out_firstNames, :out_lastNames, :out_phones, :out_birthdates)", nativeQuery = true)
    List<Map<String, Object>> obtenerClientesOrdenadosPorPrimerNombreAsc(@Param("out_id_cedulas") String[] out_id_cedulas,
                                                              @Param("out_firstNames") String[] out_firstNames,
                                                              @Param("out_lastNames") String[] out_lastNames,
                                                              @Param("out_phones") String[] out_phones,
                                                              @Param("out_birthdates") String[] out_birthdates);
